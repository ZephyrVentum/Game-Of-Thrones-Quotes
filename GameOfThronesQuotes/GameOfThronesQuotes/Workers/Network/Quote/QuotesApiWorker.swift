...
class QuotesApiWorker{
    ...
    func getRandomQuote(completer: @escaping (Result<QuoteResponse, NetworkError>) -> Void){
        URLSession.shared.dataTask(with: URL(string: randomQuoteUrl)!, completionHandler: { data, response, error in
